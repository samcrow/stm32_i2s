...
//!
//! Pins:
//! * PA1 - Synchronization (toggles when the sample rate resets)
//! * PA4, AF5 - I2S1_WS
//! * PA5, AF5 - I2S1_CK
//! * PA7, AF5 - I2S1_SD
//! * PC4, AF5 - I2S1_MCK
...
const SAMPLE_RATES: [u32; 6] = [8000, 16000, 22050, 32000, 44100, 48000];
...
fn main() -> ! {
    ...
    let i2s_in_frequency = 200.mhz(); // 200 MHz when master clock output is enabled
    let clocks = rcc
        .cfgr
        .i2s_apb1_clk(i2s_in_frequency)
        .i2s_apb2_clk(i2s_in_frequency)
        .freeze();
