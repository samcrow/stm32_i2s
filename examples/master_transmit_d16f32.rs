//!
//! Periodically transmits a sequence of 16-bit samples (extended into 32-bit frames)
...
//!
//! To compile:
//! RUSTFLAGS="-C link-arg=-Tlink.x" cargo build --example master_transmit_d16f32 --target thumbv7em-none-eabihf --release
//!
