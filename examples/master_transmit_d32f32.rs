//!
//! Periodically transmits a sequence of 32-bit samples
...
//!
//! To compile:
//! RUSTFLAGS="-C link-arg=-Tlink.x" cargo build --example master_transmit_d32f32 --target thumbv7em-none-eabihf --release
//!
...
use stm32_i2s::v12x::format::{Data32Frame32, FrameFormat};
...
const TEST_SAMPLES: [i32; 12] = [
    0x0000_0000,
    0x0000_0000,
    0xe926_aa55_u32 as i32,
    0x3726_55aa_u32 as i32,
    0xbc01_0000_u32 as i32,
    0xba99_ffff_u32 as i32,
    0x19e9_1010_u32 as i32,
    0x27f3_aaaa_u32 as i32,
    0x12cd_5555_u32 as i32,
    0xf7e9_e621_u32 as i32,
    0x0000_0000,
    0x0000_0000,
];
