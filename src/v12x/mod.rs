...
use self::format::{DataFormat, FrameFormat, FrameSync};
use self::pac::spi1::i2scfgr::I2SCFG_A;
pub use self::pac::spi1::RegisterBlock;
use crate::{Channel, Polarity};
...
///
/// ```no_run
/// # use stm32_i2s::v12x::{I2s, Instance, MasterConfig, InitMode};
    ...
    F: DataFormat,
{
    ...
    pub fn sample_ready(&self) -> Option<Channel> {
        use crate::v12x::pac::spi1::sr::CHSIDE_A;
